...
:======================================================================================================================================================
:Gracias a abbodi1406 por , que se utilizó como base en este script
:Gracias a DEV por la gran y continua ayuda para mejorar este script.
:Gracias a AR_Alex por las ideas y sugerencias..
:======================================================================================================================================================
...
echo Para hacerlo, haga clic derecho en este script y seleccione 'Ejecutar como administrador'
echo.
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] Verifique la activacion de Windows y Office       ^|
Echo.                    ^|                   _______________                       ^|  
echo.                    ^|                                                         ^|
echo.                    ^|   [4] Crear tarea de renovacion                         ^| 
echo.                    ^|                                                         ^| 
echo.                    ^|   [5] Desinstalacion completa                           ^| 
echo.                    ^|                                                         ^|
echo.                    ^|   [6] Extraer $OEM$ Carpeta al escritorio               ^|  
Echo.                    ^|                   _______________                       ^|  
echo.                    ^|                                                         ^|       
Echo.                    ^|   [7] Buscar actualizaciones de secuencias de comandos  ^|
echo.                    ^|   [8] Activar Office Retail A Vl 2013-2016-2019         ^| 
Echo.                    ^|                                                         ^|
Echo.                    ^|   [9] Salir                                             ^|
Echo.                    ^|_________________________________________________________^|
ECHO.            
choice /C:123456789 /N /M ".                   Ingrese su eleccion [1,2,3,4,5,6,7,8] : "
if errorlevel 9 goto:Exit
if errorlevel 8 goto:activatevl
...
REM ReadMe Start
 ...
 - Activador 2021 By @dev.cmd 
   Activa Windows y Office a traves de KMS Servers.  
 
 ===============================================================================================

 # Observaciones:  
 
 - Si solo desea activar durante 180 dias y no desea ningun remanente (nombre del servidor KMS)
   entonces primero debe elegir la opcion no. 2 (Activar) y luego use la opcion no. 5 
  (Desinstalacion completa).
                                                                                               
 - Si desea una activacion de por vida, debe elegir la opcion no. 2 (Activar) y despues 
   esa opcion no. 4 (Crear tarea de renovacion). Tenga en cuenta que su sistema debe conectarse a 
   Internet una vez en un periodo de seis meses, para la activacion de por vida.

 - Si no selecciona la opcion no. 5 (Desinstalacion completa) despues de la activacion o la tarea 
   de renovacion luego, Office vl instalada mas tarde (2013 y 2016 no 2010) se activara 
   automaticamente si esta en línea y usted no es necesario ejecutar este activador de nuevo para
   vl office. Tenga en cuenta que este tipo de activacion automatica solo sucedera en sistemas 
   Windows 8.1 / 10, no en Windows 7.

 - Si la fecha de su sistema no es correcta debido a 'Bad Bios Battery' en ese caso, corrija la 
   bateria bios o asegurese de que el sistema este siempre en linea o use otros activadores 
   fuera de linea. 
 
 - El script omitira la activacion para cualquier ventana u oficina si se encuentra 
   activado permanentemente.  
 
 - Para la mayoria de los productos, el periodo de activacion sera de 180 dias, pero para algunos 
   productos es de 30  45 dias, etc. 
                                                                                               
 - Este script activara VL Office, no el Retail (C2R) office.  
   Por lo tanto, convierta el Office Retail en VL o simplemente descargue Official VL de
   Repo de GezoeSloog (miembro de MDL) repo https://pastebin.com/raw/Hk2RgYzF 
   Verifique si VL office es genuino o no, con esta herramienta.
   https://genuineisoverifier.weebly.com/

 - Para preactivar windows durante la instalacion, haga lo siguiente Utilice la opcion No. 6 
   en script y extraiga el $OEM$ Carpeta al escritorio. Ahora copia esto $OEM$ Carpeta a "sources"
   carpeta en el medio de instalacion.  El directorio aparecera asi. iso/usb: \sources\$OEM$ 
   Ahora usa esto iso/usb para instalar Windows y se activara automaticamente en el primer 
   contacto en linea
 ...
 # Fix:
  ...
  Si tiene errores de activación, intente reconstruir la licencia Tokens.dat como se sugiere:
  https://support.microsoft.com/en-us/help/2736303

  lanzar el simbolo del sistema como administrador y ejecutar estos comandos respectivamente:
  net stop sppsvc
  ren %windir%\System32\spp\store\2.0\tokens.dat tokens.bar
  net start sppsvc
  cscript %windir%\system32\slmgr.vbs /rilc

  luego reinicie el sistema dos veces,
  luego, ejecute el script para activar.
 ...
 # Creditos: 
   ...
   Abbodi1406    - Autor de SppExtComObjPatcher-kms\2-Activate-Local.cmd que uso 
                   como base en este script en línea.
				   
   DEV          - ttrabaja y continua ayudando para mejorar este script.
                   
   AR_Alex       - Ideas interesantes, sugerencias y ayuda.. 
   
   WindowsAddict - Probar, administrar y publicar.  
...
echo       ============================================================================
echo         Nota: Asegurese de estar conectado a Internet para una activacion exitosa.
echo       ============================================================================
echo.
choice /C:GC /N /M "[C] Continuar con la activacion [G] Regresar : "
...
ECHO.
ECHO ************************************************************
ECHO ***              Office 2016 %bit%-bit Estado            ***
ECHO ************************************************************
...
ECHO.
ECHO ************************************************************
ECHO ***              Office 2016 32-bit Estado               ***
ECHO ************************************************************
cscript //nologo "%office%\OSPP.VBS" /dstatus
)
...
ECHO.
ECHO ************************************************************
ECHO ***              Office 2013 %bit%-bit Estado            ***
ECHO ************************************************************
cscript //nologo "%office%\OSPP.VBS" /dstatus
)
...
ECHO.
ECHO ************************************************************
ECHO ***              Office 2013 32-bit Estado               ***
ECHO ************************************************************
cscript //nologo "%office%\OSPP.VBS" /dstatus
)
...
ECHO.
ECHO ************************************************************
ECHO ***              Office 2010 %bit%-bit Estado            ***
ECHO ************************************************************
cscript //nologo "%office%\OSPP.VBS" /dstatus
)
...
ECHO.
ECHO ************************************************************
ECHO ***              Office 2010 32-bit Estado               ***
ECHO ************************************************************
cscript //nologo "%office%\OSPP.VBS" /dstatus
)
...
ECHO.
ECHO ************************************************************
ECHO ***              Office 2016/2019 C2R Estado             ***
ECHO ************************************************************
cscript //nologo "%office%\OSPP.VBS" /dstatus
)
...
echo      ============================================================================
echo       Nota: Esta opcion creara una tarea de renovacion automatica semanal.  
echo             Su sistema debe conectarse a Internet una vez cada seis meses.,
echo             para activacion de por vida.
echo             El archivo de tareas se creara en C:\Windows\Online_KMS_Activation_Script
echo             Y puede ver su tarea programada en el programador de tareas.
echo      ============================================================================
echo.
choice /C:GC /N /M "[C] Crear tarea de renovacion [G] Salir : "
        if %errorlevel%==1 Goto:MainMenu
		cls
...
echo.
echo =========================================
echo  Tarea de renovacion creada.
echo =========================================
echo.
echo Pulse cualquier tecla para continuar...
pause >nul
...
mode con cols=98 lines=30
echo       ================================================================================
echo        Nota: Esta opcion eliminara la tarea de renovacion + Task Files + Clear KMS Cache  
echo              y el nombre del servidor KMS del sistema.
echo       ================================================================================
echo.
choice /C:GC /N /M "[C] Completar desintalacion [G] Salir : "
        if %errorlevel%==1 Goto:MainMenu
		cls
...
schtasks /delete /tn Online_KMS_Activation_Script-Renewal /f 1>nul 2>nul
schtasks /delete /tn Online_KMS_Activation_Script-Run_Once /f 1>nul 2>nul
echo Eliminar archivos de tareas...
@RD /s /q "%windir%\Online_KMS_Activation_Script" >nul 2>&1
...
echo.
echo ==============================
echo  La desinstalacion esta completa.
echo ==============================
echo.
echo Pulse cualquier tecla para continuar...
pause >nul
...
mode con cols=98 lines=30
echo     ==================================================================================
echo       Nota: Esta opcion creara la carpeta $OEM$ Carpeta de este activador en su escritorio,   
echo             Que puede utilizar para crear una instalacion de Windows preactivada. 
echo             Para obtener mas informacion, utilice Leame.
echo     ==================================================================================
echo.
...
echo.
echo               ================================================
echo                 Error - $OEM$ la carpeta no fue creada porque 
echo                   $OEM$ La carpeta ya existe en el escritorio.
echo               ================================================
echo. 
echo Pulse cualquier tecla para continuar...
pause >nul
...
ping www.google.com -n 1 -w 10000 > nul || (
   if %loop%== %max_loop% (
        echo Internet no está conectado.
   ...
   echo Esperando 30 s&se acabó el tiempo /t 30>nul
   set /a loop=%loop%+1
   goto repeat
)
echo Internet esta conectado.
...
echo. &echo Probar con el servidor KMS %KMS_IP% &echo.
...
echo.
if %activation_ok%==0 (
echo La activación no tuvo éxito. Probar con otro servidor.
set /a server_num+=1
goto :server
)
...
wmic path %sps% get Version >nul 2>&1 || (echo.&echo Ninguna instalacion de Office %aword% detectada...&exit /b)
...
echo El producto está activado permanentemente.
exit /b
)
call :insKey %app%
exit /b
...
echo.
echo Si keys.Exists^(edition^) luego
...
for /f "tokens=2 delims==" %%x in ('"wmic path %spp% where ID='%1' get Name /VALUE"') do echo Activando: %%x
...
echo Activación del producto fallida: 0x%=ExitCode%
set activation_ok=0
)
...
:UnsupportedVersion
echo ==== ERROR ====
echo Se detectó una versión de SO incompatible.
echo El proyecto solo es compatible con Windows 7/8 / 8.1 / 10 y su servidor equivalente.
echo.
echo presiona cualquier tecla para salir...
pause >nul
goto :eof
...
echo.
echo ======================================================
echo  $OEM$ La carpeta se creo correctamente en el escritorio.
echo ======================================================
echo Pulse cualquier tecla para continuar...
pause >nul
goto:MAINMENU
...
:======================================================================================================================================================
:ScriptUpdates
start https://github.com/eiko202/kms-2021
goto:MAINMENU
